...
const ComingSoon = () => {
  ...
  return (
    <section className="w-screen min-h-screen grow items-center bg-[url('/images/heromesh.png')] relative">
      ...
      <div className="container w-full h-full flex flex-col justify-center items-center py-8 lg:py-20 text-center ">
        ...
        <p className="p text-allports-700 mt-5 mb-5 lg:mb-12 max-w-xs md:max-w-5xl">
        ...
        <Form {...form}>
          <form
            ...
            className="w-full max-w-lg mx-auto flex  gap-x-2 mb-6"
          >
            <FormField
